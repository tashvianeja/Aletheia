...
def test_coverage_gate_aggregates_required_modules_independently_from_overall() -> None:
    report = {
        "src/aletheia/core/service.py": {"summary": {"num_statements": 80, "covered_lines": 68}},
        "src/aletheia/engine/decision.py": {"summary": {"num_statements": 20, "covered_lines": 17}},
        "src/aletheia/ui/dashboard.py": {"summary": {"num_statements": 100, "covered_lines": 40}},
    }
...
def test_coverage_gate_normalizes_windows_report_paths() -> None:
    report = {
        r"src\aletheia\storage\store.py": {"summary": {"num_statements": 10, "covered_lines": 9}}
    }
