...
The adapter can create/remove a user LaunchAgent for autostart. Main and fresh-clone app/DMG lifecycles passed visible onboarding/tray, native protocol-v1 readiness, bundled OCR, uninstall, and registration restoration; all 339 Mach-O slices audited at a maximum minimum version of macOS 13. Current Intel crypto packaging requires Rust/Cargo and checksum-pinned static OpenSSL 3.5.8 for macOS 13; Intel CI remains pending. Notarization, Gatekeeper behavior, and protected permission grants remain pending. “Full Disk Access granted” only indicates that this app may read certain protected locations; it does not prove full OS-wide monitoring.
