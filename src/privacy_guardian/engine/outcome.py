...
from privacy_guardian.engine.labels import article, category_label, lowered, plural_label
...
def _access(event: PrivacyEvent) -> str:
    ...
    if isinstance(event, PermissionRequestEvent) and event.permission:
        from privacy_guardian.sensors.platform.base import PERMISSION_CATEGORIES
