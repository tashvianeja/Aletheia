...
from privacy_guardian.intelligence.tokenizer import encode_batch

LOGGER = logging.getLogger("privacy_guardian.intelligence")
DIMENSIONS = 384
...
def model_path() -> Path | None:
    try:
        with as_file(files("privacy_guardian.data.models").joinpath(MODEL_FILE)) as path:
