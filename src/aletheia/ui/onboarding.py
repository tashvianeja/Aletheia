...
The browser extension is where most of Aletheia's signal comes from, so setup
...
from aletheia.ui.theme import palette, stylesheet
...
class Onboarding(QWizard):
    ...
    def _finish(self) -> None:
        ...
        if self.key_input.text():
            from aletheia.llm.client import set_api_key
