...
def diagnose(settings: Settings) -> dict[str, Any]:
    ...
    from aletheia.util.installation import HOST_NAME, manifest_locations
    ...
    return {
        "version": importlib.metadata.version("aletheia"),
...
def main() -> int:
    ...
    if arguments.native_host:
        from aletheia.core.ipc.native_host import main as host_main
    ...
    from aletheia.core.events import Decision, UserResponse
    from aletheia.core.service import Service
    from aletheia.ui.card import bring_to_front
    ...
    from aletheia.ui.popup import PopupQueue
    from aletheia.ui.tray import GuardianTray
    ...
    class Controller:
        ...
        async def _start(self) -> None:
            ...
            if not arguments.smoke_test:
                ...
                from aletheia.sensors.documents import OpenDocumentMonitor
        ...
        def register_bridge(self) -> tuple[bool, str]:
            ...
            """
            from aletheia.util.installation import HOST_NAME, install, manifest_locations
        ...
        def test_llm_connection(self, key: str, model: str) -> None:
            ...
            async def run() -> None:
                from aletheia.llm.client import ConnectionCheck, check_connection
    ...
    app.setApplicationName("Aletheia")
