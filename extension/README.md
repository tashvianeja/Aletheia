# Aletheia browser extension

This is the browser sensor/actuator for Aletheia. It observes page context for file uploads, forms, consent, documents, and tracking; sends schema-validated requests to the local native host `com.aletheia.host`; and applies user-approved browser actions such as tracking-rule updates.
