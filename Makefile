...
run:
	uv run aletheia
test:
	uv run pytest tests/unit tests/integration tests/platform tests/packaging -m "not perf" --cov=aletheia --cov-report=term-missing --cov-report=xml --cov-report=json --cov-fail-under=0
